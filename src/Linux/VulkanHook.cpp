...
VulkanHook_t::VulkanHook_t()
    : _Hooked(false), _X11Hooked(false), _Window(nullptr), _SentOutOfDate(false),
      _HookState(OverlayHookState::Removing), _VulkanLoader(nullptr), _VulkanAllocationCallbacks(nullptr),
